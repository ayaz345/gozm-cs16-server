        ...
        <table cellspacing='1' class='listtable' width='100%'>
          ...
          <tr {if $servers.maxplayers == ""}bgcolor="#FFEAEA"{elseif $servers.maxplayers == 0 || $servers.maxplayers == "-" || $servers.curplayers == "-"}bgcolor="#D3D8DC"{else}bgcolor="#D3D8DC" style="CURSOR:pointer;" onClick="javascript:submit()" onMouseOver="this.style.backgroundColor='#C7CCD2'" onMouseOut="this.style.backgroundColor='#D3D8DC'"{/if}>
