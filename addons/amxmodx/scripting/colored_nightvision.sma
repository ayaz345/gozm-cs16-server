...
{
    new nvault_file[10]
    copy(nvault_file, charsmax(nvault_file), "gozm_nvg")
...
nvg_menu(id)
{
    ...
    static i_Menu
    i_Menu = menu_create("\yЦвет NVG:", "nvg_menu_handler" )
...
public nvg_menu_handler(id, menu, item)
{
    ...
    static s_Data[3], s_Name[64], i_Access, i_Callback, i_Key
