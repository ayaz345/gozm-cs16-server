...
new g_maxplayers
new g_CustomViewModelsPosition[MAX_PLAYERS][CSW_LAST_WEAPON+1]
new Array:g_CustomViewModelsNames
new g_CustomViewModelsCount
new g_CustomWeaponModelsPosition[MAX_PLAYERS][CSW_LAST_WEAPON+1]
...
public native_set_player_view_model(plugin_id, num_params)
{
    ...
    static current_weapon_ent, current_weapon_id
    current_weapon_ent = fm_cs_get_current_weapon_ent(id)
    current_weapon_id = pev_valid(current_weapon_ent) ? cs_get_weapon_id(current_weapon_ent) : -1
...
{
    static pos_delete
    pos_delete = g_CustomViewModelsPosition[id][weaponid]
...
{
    static pos_delete
    pos_delete = g_CustomWeaponModelsPosition[id][weaponid]
