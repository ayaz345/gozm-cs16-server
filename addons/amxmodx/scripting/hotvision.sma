...
public plugin_init()
{
	...
	g_iCvarHotVisionRadar      = register_cvar("hotvision_radar", "0");
	g_iCvarHotVisionRadarRange = register_cvar("hotvision_radar_range", "1024.0");
	g_iCvarHotVisionModels     = register_cvar("hotvision_models", "0");
	g_iCvarHotVisionWalls      = register_cvar("hotvision_walls", "0");
	g_iCvarHotVisionEffectFix  = register_cvar("hotvision_effect_fix", "2");
	g_iCvarHotVisionObjectGlow = register_cvar("hotvision_object_glow", "0");
