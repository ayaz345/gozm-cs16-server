...
#define BANNER_FILE "gfx/images/gozm_banner_v1-1.tga"
#define TASKID 6892
...
{
	precache_generic("gfx/images/gozm_banner_v1-1.tga");
	precache_generic("gfx/images/gozm_banner_v1-2.tga");
	precache_generic("gfx/images/gozm_banner_v1-3.tga");
	precache_generic("gfx/images/gozm_banner_v1-4.tga")
}
